  ...
  return (
    <AppShell pageTitle={t("nav.dashboard")}>
      <div className="space-y-6 max-w-6xl mx-auto">
        ...
        {/* 1. UNIFIED COMMAND HUB HERO (One Sleek Cohesive Surface) */}
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  {profile?.learning_history?.length
                    ? `${profile.learning_history.length} completed lessons · AI Teacher ready for today's goals`
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 bg-slate-900/90 p-1.5 pl-4 rounded-full border border-slate-700/80 focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-500/20 transition-all">
              <input
                ...
                placeholder="What would you like to master today? (e.g. Linear Regression, Ohm's Law, Binary Search...)"
            ...
            <div className="flex items-center gap-2 flex-wrap text-xs">
              ...
              >
                ...
                <span>Upload Notes / Document</span>
              </Link>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-slate-400">
                    {activeLesson.plan?.segments.length || 3} concepts planned · {activeLesson.plan?.total_estimated_minutes || 20} min session
                  </p>
                </div>
              </div>
            ...
            <div className="pt-3 border-t border-slate-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-900/50 -mx-6 -mb-6 sm:-mx-7 sm:-mb-7 p-4 sm:px-7 sm:py-3.5 rounded-b-3xl">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-slate-400">
                    Next milestone in your personalized curriculum path
                  </p>
                </div>
              </div>
